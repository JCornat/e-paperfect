...
def draw():
    ...
    image_draw.text((16, 16), "MARS", font=utils.font(size="lg", weight="Bold"), fill=0, anchor="la")
    image_draw.text((card_size[0] - 16, card_size[1] - 16), "DIMANCHE", font=utils.font(size="lg"), fill=0, anchor="rs")
